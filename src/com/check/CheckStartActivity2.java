...
public class CheckStartActivity2 extends ActionBarActivity {
	...
	private String succeed=null;
		...
		protected void onCreate(Bundle savedInstanceState) {
		    ...
		    ipData helper=new ipData(CheckStartActivity2.this);
			ipUser ipuser=helper.query(1);
			ip=ipuser.getNumber();	
			connectURL="http://"+ip+":8088/elevatorData/checkSpeed2.php";
			Intent i=getIntent();
		...
		{
			TextView carSafeView=(TextView)findViewById(R.id.counterWeight);
			carSafeView.setText(R.string.CounterWeight);
	        	...
	        	switch(msg.what)
				{
					...
					default:
						...
						if("succeed".equals(succeed))
			        	{
							...
							Toast.makeText(CheckStartActivity2.this, "提交成功", Toast.LENGTH_LONG).show();
						
							Intent intent=new Intent();
							intent.setClass(CheckStartActivity2.this, CheckStartActivity3.class);
							intent.putExtra("reportNo", reportNo);
							CheckStartActivity2.this.startActivity(intent);
						
						}else{
							Toast.makeText(CheckStartActivity2.this, "提交失败", Toast.LENGTH_LONG).show();
						}
	    ...
	    class nextListener implements android.view.View.OnClickListener {
	    	...
	    	public void onClick(View v) {
	    		...
	    		if (TextUtils.isEmpty(reportNo) ) {  
	                Toast.makeText(CheckStartActivity2.this, "请填写完整", Toast.LENGTH_LONG).show();
	    		}else{
	    			new Thread() {
	    	            @Override
	    	            public void run() { 
